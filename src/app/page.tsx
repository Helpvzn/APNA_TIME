...
export default function Home() {
  return (
    <main className="min-h-screen bg-wine-darker">
      {/* Hero Section */}
      <section className="relative overflow-hidden">
        {/* Animated background gradient */}
        <div className="absolute inset-0 bg-wine-gradient opacity-10"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24 lg:py-32">
          <div className="text-center">
            {/* Logo/Icon */}
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-wine-gradient mb-6 sm:mb-8 animate-heartbeat">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 sm:mb-6">
              ...
              <span className="block text-transparent bg-clip-text bg-wine-gradient">
                SaaS
              </span>
            </h1>
      ...
      {/* Features Section */}
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-wine-dark">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12 md:mb-16">
            <span className="text-white">Perfect for </span>
            <span className="text-transparent bg-clip-text bg-wine-gradient">Every Professional</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            {/* Consultant Card */}
            <div className="group p-6 sm:p-8 bg-wine-card/50 backdrop-blur-sm rounded-2xl border border-wine-purple/20 hover:border-wine-purple/50 transition-all hover:scale-105 hover:shadow-xl hover:shadow-wine-purple/10">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-wine-purple/20 flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-wine-purple/30 transition-colors">
                <Users className="w-6 h-6 sm:w-7 sm:h-7 text-wine-purple" />
              </div>
