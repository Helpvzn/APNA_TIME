    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-8">
                ...
                {!organization.google_connected_email && (
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-xl font-bold text-blue-900 mb-2">🚀 Get Started with Apna Time</h2>
                            <p className="text-blue-700 mb-6 max-w-2xl">
                                You're almost there! Connect your Google Calendar to prevent double bookings and sync your schedule automatically.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-4">
                                <a
                                    href="/api/integrations/google/auth"
                                    className="flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
                                >
                                    <img src="https://www.google.com/favicon.ico" alt="G" className="w-5 h-5 mr-3 bg-white rounded-full p-0.5" />
                                ...
                                <a
                                    ...
                                    className="flex items-center justify-center px-6 py-3 bg-white text-blue-700 font-semibold rounded-lg border border-blue-200 hover:bg-blue-100 transition-colors"
                                >
